...
var projectsToLoad = [
    ...
    new Item("horizontalDisplay", "../Assets/videos/carAI/carAIProjectVideo.mp4", "Self Driving Car", "Simulates F1 cars driving around multiple different Formula 1 tracks that can be customised by the user."),
    new Item("verticalDisplay", "../Assets/videos/teachingTracker/teachingTrackerVideo.mp4", "Teaching Tracker", "An application that helps track: Where you worked, what day you worked, what role you played, and the description of what happened during the lesson"),
]
